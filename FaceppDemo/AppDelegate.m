...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //友盟社会化分享
    [UMSocialData setAppKey:@"54866bd5fd98c597e20004cb"];
    //打开新浪微博的SSO开关，设置新浪微博回调地址
    [UMSocialSinaHandler openSSOWithRedirectURL:@"http://sns.whalecloud.com/sina2/callback"];
    //设置微信AppId、appSecret，分享url
    [UMSocialWechatHandler setWXAppId:@"wx6d7bb9df86cbfdb2" appSecret:@"9f40a377af665f8d28eed3e0939d4b53" url:@"http://www.umeng.com/social"];
    //设置分享到QQ/Qzone的应用Id，和分享url
    [UMSocialQQHandler setQQWithAppId:@"1101738853" appKey:@"gHCSVHz56Ec6D6WK" url:@"http://www.umeng.com/social"];
